...
<div class="login-container">
    <form class="login-form" method="post" action="store_user.php" onsubmit="return validateForm()">
    <h1>Signup</h1>
    <h2>
        <?php
        session_start();
    ...
    <p>Already have an account? <a href="login.php"><button type="submit" class="btn btn-primary btn-ghost">
    LOGIN</button></a></p>
</div>
